...
function NewAudioStream(src_format, src_channels, src_rate, dst_format, dst_channels, dst_rate)
    ccall((:SDL_NewAudioStream, libsdl2), Ptr{AudioStream}, (AudioFormat, Uint8, Cint, AudioFormat, Uint8, Cint), src_format, src_channels, src_rate, dst_format, dst_channels, dst_rate)
end

function AudioStreamPut(stream, buf, len)
    ccall((:SDL_AudioStreamPut, libsdl2), Cint, (Ptr{AudioStream}, Ptr{Cvoid}, Cint), stream, buf, len)
end

function AudioStreamGet(stream, buf, len)
    ccall((:SDL_AudioStreamGet, libsdl2), Cint, (Ptr{AudioStream}, Ptr{Cvoid}, Cint), stream, buf, len)
end

function AudioStreamAvailable(stream)
    ccall((:SDL_AudioStreamAvailable, libsdl2), Cint, (Ptr{AudioStream},), stream)
end

function AudioStreamFlush(stream)
    ccall((:SDL_AudioStreamFlush, libsdl2), Cint, (Ptr{AudioStream},), stream)
end

function AudioStreamClear(stream)
    ccall((:SDL_AudioStreamClear, libsdl2), Cvoid, (Ptr{AudioStream},), stream)
end

function FreeAudioStream(stream)
    ccall((:SDL_FreeAudioStream, libsdl2), Cvoid, (Ptr{AudioStream},), stream)
end
...
function HasExactlyOneBitSet32(x)
    ccall((:SDL_HasExactlyOneBitSet32, libsdl2), bool, (Uint32,), x)
end
# Julia wrapper for header: blendmode.h
# Automatically generated using Clang.jl


function ComposeCustomBlendMode(srcColorFactor, dstColorFactor, colorOperation, srcAlphaFactor, dstAlphaFactor, alphaOperation)
    ccall((:SDL_ComposeCustomBlendMode, libsdl2), BlendMode, (BlendFactor, BlendFactor, BlendOperation, BlendFactor, BlendFactor, BlendOperation), srcColorFactor, dstColorFactor, colorOperation, srcAlphaFactor, dstAlphaFactor, alphaOperation)
end
...
function HasAVX512F()
    ccall((:SDL_HasAVX512F, libsdl2), bool, ())
end

function HasARMSIMD()
    ccall((:SDL_HasARMSIMD, libsdl2), bool, ())
end

function HasNEON()
    ccall((:SDL_HasNEON, libsdl2), bool, ())
end
...
function GameControllerMappingForIndex(mapping_index)
    ccall((:SDL_GameControllerMappingForIndex, libsdl2), Cstring, (Cint,), mapping_index)
end
...
function GameControllerTypeForIndex(joystick_index)
    ccall((:SDL_GameControllerTypeForIndex, libsdl2), GameControllerType, (Cint,), joystick_index)
end

function GameControllerMappingForDeviceIndex(joystick_index)
    ccall((:SDL_GameControllerMappingForDeviceIndex, libsdl2), Cstring, (Cint,), joystick_index)
end
...
function GameControllerFromPlayerIndex(player_index)
    ccall((:SDL_GameControllerFromPlayerIndex, libsdl2), Ptr{GameController}, (Cint,), player_index)
end
...
function GameControllerGetType(gamecontroller)
    ccall((:SDL_GameControllerGetType, libsdl2), GameControllerType, (Ptr{GameController},), gamecontroller)
end

function GameControllerGetPlayerIndex(gamecontroller)
    ccall((:SDL_GameControllerGetPlayerIndex, libsdl2), Cint, (Ptr{GameController},), gamecontroller)
end

function GameControllerSetPlayerIndex(gamecontroller, player_index)
    ccall((:SDL_GameControllerSetPlayerIndex, libsdl2), Cvoid, (Ptr{GameController}, Cint), gamecontroller, player_index)
end

function GameControllerGetVendor(gamecontroller)
    ccall((:SDL_GameControllerGetVendor, libsdl2), Uint16, (Ptr{GameController},), gamecontroller)
end

function GameControllerGetProduct(gamecontroller)
    ccall((:SDL_GameControllerGetProduct, libsdl2), Uint16, (Ptr{GameController},), gamecontroller)
end

function GameControllerGetProductVersion(gamecontroller)
    ccall((:SDL_GameControllerGetProductVersion, libsdl2), Uint16, (Ptr{GameController},), gamecontroller)
end
...
function GameControllerRumble(gamecontroller, low_frequency_rumble, high_frequency_rumble, duration_ms)
    ccall((:SDL_GameControllerRumble, libsdl2), Cint, (Ptr{GameController}, Uint16, Uint16, Uint32), gamecontroller, low_frequency_rumble, high_frequency_rumble, duration_ms)
end
...
function JoystickGetDevicePlayerIndex(device_index)
...
function JoystickGetDeviceVendor(device_index)
    ccall((:SDL_JoystickGetDeviceVendor, libsdl2), Uint16, (Cint,), device_index)
end

function JoystickGetDeviceProduct(device_index)
    ccall((:SDL_JoystickGetDeviceProduct, libsdl2), Uint16, (Cint,), device_index)
end

function JoystickGetDeviceProductVersion(device_index)
    ccall((:SDL_JoystickGetDeviceProductVersion, libsdl2), Uint16, (Cint,), device_index)
end

function JoystickGetDeviceType(device_index)
    ccall((:SDL_JoystickGetDeviceType, libsdl2), JoystickType, (Cint,), device_index)
end

function JoystickGetDeviceInstanceID(device_index)
    ccall((:SDL_JoystickGetDeviceInstanceID, libsdl2), JoystickID, (Cint,), device_index)
end
...
function JoystickFromInstanceID(instance_id)
    ccall((:SDL_JoystickFromInstanceID, libsdl2), Ptr{Joystick}, (JoystickID,), instance_id)
end

function JoystickFromPlayerIndex(player_index)
    ccall((:SDL_JoystickFromPlayerIndex, libsdl2), Ptr{Joystick}, (Cint,), player_index)
end
...
function JoystickGetPlayerIndex(joystick)
    ccall((:SDL_JoystickGetPlayerIndex, libsdl2), Cint, (Ptr{Joystick},), joystick)
end

function JoystickSetPlayerIndex(joystick, player_index)
    ccall((:SDL_JoystickSetPlayerIndex, libsdl2), Cvoid, (Ptr{Joystick}, Cint), joystick, player_index)
end
...
function JoystickGetVendor(joystick)
    ccall((:SDL_JoystickGetVendor, libsdl2), Uint16, (Ptr{Joystick},), joystick)
end

function JoystickGetProduct(joystick)
    ccall((:SDL_JoystickGetProduct, libsdl2), Uint16, (Ptr{Joystick},), joystick)
end

function JoystickGetProductVersion(joystick)
    ccall((:SDL_JoystickGetProductVersion, libsdl2), Uint16, (Ptr{Joystick},), joystick)
end

function JoystickGetType(joystick)
    ccall((:SDL_JoystickGetType, libsdl2), JoystickType, (Ptr{Joystick},), joystick)
end
...
function JoystickGetAxisInitialState(joystick, axis, state)
    ccall((:SDL_JoystickGetAxisInitialState, libsdl2), bool, (Ptr{Joystick}, Cint, Ptr{Sint16}), joystick, axis, state)
end
...
function JoystickRumble(joystick, low_frequency_rumble, high_frequency_rumble, duration_ms)
    ccall((:SDL_JoystickRumble, libsdl2), Cint, (Ptr{Joystick}, Uint16, Uint16, Uint32), joystick, low_frequency_rumble, high_frequency_rumble, duration_ms)
end
...
# Julia wrapper for header: metal.h
# Automatically generated using Clang.jl


function Metal_CreateView(window)
    ccall((:SDL_Metal_CreateView, libsdl2), MetalView, (Ptr{Window},), window)
end

function Metal_DestroyView(view)
    ccall((:SDL_Metal_DestroyView, libsdl2), Cvoid, (MetalView,), view)
end
...
function CreateMutex()
    ccall((:SDL_CreateMutex, libsdl2), Ptr{LibSDL2.mutex}, ())
end

function LockMutex(mutex)
    ccall((:SDL_LockMutex, libsdl2), Cint, (Ptr{LibSDL2.mutex},), mutex)
end

function TryLockMutex(mutex)
    ccall((:SDL_TryLockMutex, libsdl2), Cint, (Ptr{LibSDL2.mutex},), mutex)
end

function UnlockMutex(mutex)
    ccall((:SDL_UnlockMutex, libsdl2), Cint, (Ptr{LibSDL2.mutex},), mutex)
end

function DestroyMutex(mutex)
    ccall((:SDL_DestroyMutex, libsdl2), Cvoid, (Ptr{LibSDL2.mutex},), mutex)
end

function CreateSemaphore(initial_value)
    ccall((:SDL_CreateSemaphore, libsdl2), Ptr{LibSDL2.sem}, (Uint32,), initial_value)
end

function DestroySemaphore(sem)
    ccall((:SDL_DestroySemaphore, libsdl2), Cvoid, (Ptr{LibSDL2.sem},), sem)
end

function SemWait(sem)
    ccall((:SDL_SemWait, libsdl2), Cint, (Ptr{LibSDL2.sem},), sem)
end

function SemTryWait(sem)
    ccall((:SDL_SemTryWait, libsdl2), Cint, (Ptr{LibSDL2.sem},), sem)
end

function SemWaitTimeout(sem, ms)
    ccall((:SDL_SemWaitTimeout, libsdl2), Cint, (Ptr{LibSDL2.sem}, Uint32), sem, ms)
end

function SemPost(sem)
    ccall((:SDL_SemPost, libsdl2), Cint, (Ptr{LibSDL2.sem},), sem)
end

function SemValue(sem)
    ccall((:SDL_SemValue, libsdl2), Uint32, (Ptr{LibSDL2.sem},), sem)
end

function CreateCond()
    ccall((:SDL_CreateCond, libsdl2), Ptr{LibSDL2.cond}, ())
end

function DestroyCond(cond)
    ccall((:SDL_DestroyCond, libsdl2), Cvoid, (Ptr{LibSDL2.cond},), cond)
end

function CondSignal(cond)
    ccall((:SDL_CondSignal, libsdl2), Cint, (Ptr{LibSDL2.cond},), cond)
end

function CondBroadcast(cond)
    ccall((:SDL_CondBroadcast, libsdl2), Cint, (Ptr{LibSDL2.cond},), cond)
end

function CondWait(cond, mutex)
    ccall((:SDL_CondWait, libsdl2), Cint, (Ptr{LibSDL2.cond}, Ptr{LibSDL2.mutex}), cond, mutex)
end

function CondWaitTimeout(cond, mutex, ms)
    ccall((:SDL_CondWaitTimeout, libsdl2), Cint, (Ptr{LibSDL2.cond}, Ptr{LibSDL2.mutex}, Uint32), cond, mutex, ms)
end
...
function SetTextureScaleMode(texture, scaleMode)
    ccall((:SDL_SetTextureScaleMode, libsdl2), Cint, (Ptr{Texture}, ScaleMode), texture, scaleMode)
end

function GetTextureScaleMode(texture, scaleMode)
    ccall((:SDL_GetTextureScaleMode, libsdl2), Cint, (Ptr{Texture}, Ptr{ScaleMode}), texture, scaleMode)
end
...
function LockTextureToSurface(texture, rect, surface)
    ccall((:SDL_LockTextureToSurface, libsdl2), Cint, (Ptr{Texture}, Ptr{Rect}, Ptr{Ptr{Surface}}), texture, rect, surface)
end
...
function RenderDrawPointF(renderer, x, y)
    ccall((:SDL_RenderDrawPointF, libsdl2), Cint, (Ptr{Renderer}, Cfloat, Cfloat), renderer, x, y)
end

function RenderDrawPointsF(renderer, points, count)
    ccall((:SDL_RenderDrawPointsF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FPoint}, Cint), renderer, points, count)
end

function RenderDrawLineF(renderer, x1, y1, x2, y2)
    ccall((:SDL_RenderDrawLineF, libsdl2), Cint, (Ptr{Renderer}, Cfloat, Cfloat, Cfloat, Cfloat), renderer, x1, y1, x2, y2)
end

function RenderDrawLinesF(renderer, points, count)
    ccall((:SDL_RenderDrawLinesF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FPoint}, Cint), renderer, points, count)
end

function RenderDrawRectF(renderer, rect)
    ccall((:SDL_RenderDrawRectF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FRect}), renderer, rect)
end

function RenderDrawRectsF(renderer, rects, count)
    ccall((:SDL_RenderDrawRectsF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FRect}, Cint), renderer, rects, count)
end

function RenderFillRectF(renderer, rect)
    ccall((:SDL_RenderFillRectF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FRect}), renderer, rect)
end

function RenderFillRectsF(renderer, rects, count)
    ccall((:SDL_RenderFillRectsF, libsdl2), Cint, (Ptr{Renderer}, Ptr{FRect}, Cint), renderer, rects, count)
end

function RenderCopyF(renderer, texture, srcrect, dstrect)
    ccall((:SDL_RenderCopyF, libsdl2), Cint, (Ptr{Renderer}, Ptr{Texture}, Ptr{Rect}, Ptr{FRect}), renderer, texture, srcrect, dstrect)
end

function RenderCopyExF(renderer, texture, srcrect, dstrect, angle, center, flip)
    ccall((:SDL_RenderCopyExF, libsdl2), Cint, (Ptr{Renderer}, Ptr{Texture}, Ptr{Rect}, Ptr{FRect}, Cdouble, Ptr{FPoint}, RendererFlip), renderer, texture, srcrect, dstrect, angle, center, flip)
end
...
function RenderFlush(renderer)
    ccall((:SDL_RenderFlush, libsdl2), Cint, (Ptr{Renderer},), renderer)
end
...
function RenderGetMetalLayer(renderer)
    ccall((:SDL_RenderGetMetalLayer, libsdl2), Ptr{Cvoid}, (Ptr{Renderer},), renderer)
end

function RenderGetMetalCommandEncoder(renderer)
    ccall((:SDL_RenderGetMetalCommandEncoder, libsdl2), Ptr{Cvoid}, (Ptr{Renderer},), renderer)
end
...
function RWsize(context)
    ccall((:SDL_RWsize, libsdl2), Sint64, (Ptr{RWops},), context)
end

function RWseek(context, offset, whence)
    ccall((:SDL_RWseek, libsdl2), Sint64, (Ptr{RWops}, Sint64, Cint), context, offset, whence)
end

function RWtell(context)
    ccall((:SDL_RWtell, libsdl2), Sint64, (Ptr{RWops},), context)
end

function RWread(context, ptr, size, maxnum)
    ccall((:SDL_RWread, libsdl2), Csize_t, (Ptr{RWops}, Ptr{Cvoid}, Csize_t, Csize_t), context, ptr, size, maxnum)
end

function RWwrite(context, ptr, size, num)
    ccall((:SDL_RWwrite, libsdl2), Csize_t, (Ptr{RWops}, Ptr{Cvoid}, Csize_t, Csize_t), context, ptr, size, num)
end

function RWclose(context)
    ccall((:SDL_RWclose, libsdl2), Cint, (Ptr{RWops},), context)
end

function LoadFile_RW(src, datasize, freesrc)
    ccall((:SDL_LoadFile_RW, libsdl2), Ptr{Cvoid}, (Ptr{RWops}, Ptr{Csize_t}, Cint), src, datasize, freesrc)
end

function LoadFile(file, datasize)
    ccall((:SDL_LoadFile, libsdl2), Ptr{Cvoid}, (Cstring, Ptr{Csize_t}), file, datasize)
end
...
function SensorGetDeviceName(device_index)
    ccall((:SDL_SensorGetDeviceName, libsdl2), Cstring, (Cint,), device_index)
end

function SensorGetDeviceType(device_index)
    ccall((:SDL_SensorGetDeviceType, libsdl2), SensorType, (Cint,), device_index)
end

function SensorGetDeviceNonPortableType(device_index)
    ccall((:SDL_SensorGetDeviceNonPortableType, libsdl2), Cint, (Cint,), device_index)
end

function SensorGetDeviceInstanceID(device_index)
    ccall((:SDL_SensorGetDeviceInstanceID, libsdl2), SensorID, (Cint,), device_index)
end

function SensorOpen(device_index)
    ccall((:SDL_SensorOpen, libsdl2), Ptr{Sensor}, (Cint,), device_index)
end

function SensorFromInstanceID(instance_id)
    ccall((:SDL_SensorFromInstanceID, libsdl2), Ptr{Sensor}, (SensorID,), instance_id)
end

function SensorGetName(sensor)
    ccall((:SDL_SensorGetName, libsdl2), Cstring, (Ptr{Sensor},), sensor)
end

function SensorGetType(sensor)
    ccall((:SDL_SensorGetType, libsdl2), SensorType, (Ptr{Sensor},), sensor)
end

function SensorGetNonPortableType(sensor)
    ccall((:SDL_SensorGetNonPortableType, libsdl2), Cint, (Ptr{Sensor},), sensor)
end

function SensorGetInstanceID(sensor)
    ccall((:SDL_SensorGetInstanceID, libsdl2), SensorID, (Ptr{Sensor},), sensor)
end

function SensorGetData(sensor, data, num_values)
    ccall((:SDL_SensorGetData, libsdl2), Cint, (Ptr{Sensor}, Ptr{Cfloat}, Cint), sensor, data, num_values)
end

function SensorClose(sensor)
    ccall((:SDL_SensorClose, libsdl2), Cvoid, (Ptr{Sensor},), sensor)
end
...
function GetMemoryFunctions(malloc_func, calloc_func, realloc_func, free_func)
    ccall((:SDL_GetMemoryFunctions, libsdl2), Cvoid, (Ptr{LibSDL2.malloc_func}, Ptr{LibSDL2.calloc_func}, Ptr{LibSDL2.realloc_func}, Ptr{LibSDL2.free_func}), malloc_func, calloc_func, realloc_func, free_func)
end

function SetMemoryFunctions(malloc_func, calloc_func, realloc_func, free_func)
    ccall((:SDL_SetMemoryFunctions, libsdl2), Cint, (LibSDL2.malloc_func, LibSDL2.calloc_func, LibSDL2.realloc_func, LibSDL2.free_func), malloc_func, calloc_func, realloc_func, free_func)
end
...
function wcsncmp(str1, str2, maxlen)
...
function strtokr(s1, s2, saveptr)
    ccall((:SDL_strtokr, libsdl2), Cstring, (Cstring, Cstring, Ptr{Cstring}), s1, s2, saveptr)
end

function utf8strlen(str)
    ccall((:SDL_utf8strlen, libsdl2), Csize_t, (Cstring,), str)
end
...
function HasColorKey(surface)
    ccall((:SDL_HasColorKey, libsdl2), bool, (Ptr{Surface},), surface)
end
...
function DuplicateSurface(surface)
    ccall((:SDL_DuplicateSurface, libsdl2), Ptr{Surface}, (Ptr{Surface},), surface)
end
...
function SetYUVConversionMode(mode)
    ccall((:SDL_SetYUVConversionMode, libsdl2), Cvoid, (YUV_CONVERSION_MODE,), mode)
end

function GetYUVConversionMode()
    ccall((:SDL_GetYUVConversionMode, libsdl2), YUV_CONVERSION_MODE, ())
end

function GetYUVConversionModeForResolution(width, height)
    ccall((:SDL_GetYUVConversionModeForResolution, libsdl2), YUV_CONVERSION_MODE, (Cint, Cint), width, height)
end
# Julia wrapper for header: system.h
# Automatically generated using Clang.jl


function LinuxSetThreadPriority(threadID, priority)
    ccall((:SDL_LinuxSetThreadPriority, libsdl2), Cint, (Sint64, Cint), threadID, priority)
end

function IsTablet()
    ccall((:SDL_IsTablet, libsdl2), bool, ())
end
...
function OnApplicationDidReceiveMemoryWarning()
    ccall((:SDL_OnApplicationDidReceiveMemoryWarning, libsdl2), Cvoid, ())
end

function OnApplicationWillResignActive()
...
function CreateThreadWithStackSize(fn, name, stacksize, data)
    ccall((:SDL_CreateThreadWithStackSize, libsdl2), Ptr{Thread}, (ThreadFunction, Cstring, Csize_t, Ptr{Cvoid}), fn, name, stacksize, data)
end
...
function GetTouchDeviceType(touchID)
    ccall((:SDL_GetTouchDeviceType, libsdl2), TouchDeviceType, (TouchID,), touchID)
end
...
function GetDisplayOrientation(displayIndex)
    ccall((:SDL_GetDisplayOrientation, libsdl2), DisplayOrientation, (Cint,), displayIndex)
end
...
function Vulkan_LoadLibrary(path)
    ccall((:SDL_Vulkan_LoadLibrary, libsdl2), Cint, (Cstring,), path)
end

function Vulkan_GetVkGetInstanceProcAddr()
    ccall((:SDL_Vulkan_GetVkGetInstanceProcAddr, libsdl2), Ptr{Cvoid}, ())
end

function Vulkan_UnloadLibrary()
    ccall((:SDL_Vulkan_UnloadLibrary, libsdl2), Cvoid, ())
end

function Vulkan_GetInstanceExtensions(window, pCount, pNames)
    ccall((:SDL_Vulkan_GetInstanceExtensions, libsdl2), bool, (Ptr{Window}, Ptr{UInt32}, Ptr{Cstring}), window, pCount, pNames)
end

function Vulkan_CreateSurface(window, instance, surface)
    ccall((:SDL_Vulkan_CreateSurface, libsdl2), bool, (Ptr{Window}, VkInstance, Ptr{VkSurfaceKHR}), window, instance, surface)
end

function Vulkan_GetDrawableSize(window, w, h)
    ccall((:SDL_Vulkan_GetDrawableSize, libsdl2), Cvoid, (Ptr{Window}, Ptr{Cint}, Ptr{Cint}), window, w, h)
end
